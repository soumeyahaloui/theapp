...
class FirstScreen(Screen):
    def __init__(self, **kwargs):
        ...
        start_button = CustomButton(
            text="Démarrer",  # French for "Start"
            size_hint=(None, None),
            size=(dp(240), dp(80)),
    ...
    def open_settings_popup(self, instance):
        ...
        language_button = CustomButton(
            text="Langue",  # French for "Language"
            size_hint=(1, None),
            size=(dp(200), dp(50))
        )
        ...
        help_button = CustomButton(
            text="Aide",  # French for "Help"
            size_hint=(1, None),
            size=(dp(200), dp(50))
        )
        help_button.bind(on_press=lambda x: print("Aide cliqué"))

        about_button = CustomButton(
            text="À propos",  # French for "About"
            size_hint=(1, None),
            size=(dp(200), dp(50))
        )
        about_button.bind(on_press=lambda x: print("À propos cliqué"))
        ...
        popup = Popup(
            title="Paramètres",  # French for "Settings"
    ...
    def open_language_popup(self, instance):
        ...
        french_button = CustomButton(
            text="Français",  # French for "French"
            size_hint=(1, None),
            size=(dp(200), dp(50))
        )
        ...
        language_popup = Popup(
            title="Sélectionner la langue",  # French for "Select Language"
    ...
    def __init__(self, **kwargs):
        ...
        for category in categories:
            ...
            if category == "Animaux":
                ...
                button.bind(on_press=lambda instance, cat=category: print(f"{cat} écran non encore implémenté."))
            grid.add_widget(button)
        scroll_view.add_widget(grid)
        layout.add_widget(scroll_view)
        back_button = CustomButton(
            text="< Retour",  # French for "< Back"
            size_hint=(None, None),
            size=(dp(80), dp(40)),
...
class AnimalCategoryScreen(Screen):
    def __init__(self, **kwargs):
        ...
        layout = FloatLayout()
        categories = ["Animaux Domestiques", "Animaux Sauvages", "Animaux de Ferme", "Oiseaux", "Créatures Marines", "Insectes"]
        grid = GridLayout(
            cols=2,
            spacing=dp(10),
            padding=[dp(10), dp(20), dp(10), dp(20)],
...
class WildAnimalsScreen(Screen):
    ...
    def play_audio(self, audio_file):
        ...
        if sound:
            ...
            print(f"Échec du chargement du son : {audio_file}")
